{ flakeConfig, pkgs, ... }: {
    ...
    services.tor = {
        ...
        settings = {
            ...
            Bridge = [
                # Aug 25, 2024 | avg ping: 30 ms
                # Sep 01, 2024 | avg ping: 30 ms
                "obfs4 141.95.108.162:10769 91FE36AC270A8AB59049A1A311FC25042117D4A6 cert=ehjEhMFQhsYWBOudFC3g9byf5e+awZjMJQKLV0k1VLE32QhSDamTxaEicywGZO5tg2IlRw iat-mode=0"
