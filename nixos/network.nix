{ flakeConfig, lib, pkgs, pkgs-unstable, ... }: {
    ...
    systemd.services.byedpi = {
        ...
        script = "${pkgs-unstable.byedpi}/bin/ciadpi -s1 -q1 -Y -Ar -s5 -o1+s -At -f-1 -r1+s -As -s1 -o1 +s -s-1 -An --ip 0.0.0.0 --port 11050";
    };
    ...
    services.tor = {
        ...
        settings = {
            ...
            Bridge = [
                ...
                "obfs4 86.127.245.200:8080 B646D7A89BD9F8128A3AED440B4A1168ED505F65 cert=HVQbUpOskR1NmkaciXRY3XsiPuodTfowGgdR+/8HfKanu/l1wKAsOj20Fx+lsidT/w2vUw iat-mode=0"
